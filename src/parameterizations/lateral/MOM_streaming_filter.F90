...
!!
!! The algorithm detects the instantaneous, narrowband tidal signals (u1) from the broadband model
!! output (u) by solving a set of coupled ODEs (the filter equations) at each time step.
!!
